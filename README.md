...
- Website: https://steuerklassen-rechner.online
...
Dieses Projekt ist Open Source (MIT). Beiträge sind willkommen:

- Repository: https://github.com/Mortl94/Steuerklassen-Rechner-fuer-Ehepaare
- Issue erstellen: https://github.com/Mortl94/Steuerklassen-Rechner-fuer-Ehepaare/issues/new
- Pull Request erstellen: https://github.com/Mortl94/Steuerklassen-Rechner-fuer-Ehepaare/compare

Kurzer Ablauf:

1. Issue eröffnen (bei Bugs/Fragen) oder direkt mit kleinem Fix starten.
2. Änderungen im eigenen Branch umsetzen und lokal testen.
3. Pull Request auf `main` erstellen.

Bitte beachte bei Änderungen an der Steuerlogik:
...
Die Commit-Historie wurde bewusst auf einen sauberen Initial-Commit reduziert. Ein Backup-Tag auf die frühere Historie bleibt im Repository erhalten.
